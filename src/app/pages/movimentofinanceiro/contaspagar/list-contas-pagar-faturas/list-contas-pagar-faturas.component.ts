...
@Component({
  selector: 'app-list-contas-pagar-faturas',
  templateUrl: './list-contas-pagar-faturas.component.html',
  styleUrls: ['./list-contas-pagar-faturas.component.css']
})
export class ListContasPagarFaturasComponent implements OnInit {
  customIntMaskConfig = {
    align: "right",
    allowNegative: true,
    allowZero: true,
