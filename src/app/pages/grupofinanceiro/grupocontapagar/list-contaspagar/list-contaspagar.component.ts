...
@Component({
  selector: 'app-list-contaspagar',
  templateUrl: './list-contaspagar.component.html',
  styleUrls: ['./list-contaspagar.component.css']
})
      ...
      .then(
        (response) => {
          console.log(response.body);
           this.router.navigate(['grupocontaspagar/', response.body]);
        },
        (error) => {
          console.log(error);
